...
urlpatterns = [
    ...
    path('create_course', views.faculty_add_course, name='faculty_add_course'),
    ...
    path('materials/<int:code>/', views.allMaterials, name='allMaterials'),
    path('student-assignments/<int:code>/',
         views.allAssignmentsSTD, name='student-assignments'),
    path('student-materials/<int:code>/',
         views.allMaterialsSTD, name='student_materials'),
